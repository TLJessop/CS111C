...
T[] result = (T[]) new Comparable[numberOfEntries]; // Unchecked cast
   ...
   public ListInterface<T> getAllLessThan(T entry) {
    ...
    public boolean equals(Object obj) {
        ...
        if( this.getClass() == obj.getClass()) {
            ...
            for (int i = 1; i <= this.numberOfEntries; i++){
              if (!this.list[i].equals(otherList.list[i])){
                  return false;
              }
            }
        } else {
    ...
    public int compareTo(AList<T> otherList) {
       if (this == otherList ) return 0;
       if (otherList == null) return -5;

        if(Integer.compare(this.numberOfEntries, otherList.numberOfEntries) != 0){
    ...
    public static void main(String[] args){
       ...
       AList<Integer> alist2 = new AList<>();
       ...
       //alist2.add(-555);
        ...
        System.out.println(alist.compareTo(alist2));

        System.out.println(Arrays.toString(alist.toArray()));
         System.out.println(Arrays.toString(alist2.toArray()));
   }
